...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/little-lab-0ea3)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/little-lab-0ea3
```

A live public deployment of this template is available at [https://little-lab-0ea3.templates.workers.dev](https://little-lab-0ea3.templates.workers.dev)
